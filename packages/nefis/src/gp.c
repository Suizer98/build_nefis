...
//
//------------------------------------------------------------------------------
// $Id: gp.c 142295 2023-01-10 08:25:27Z klapwijk $
...
#include <unistd.h> /* grep -r "lseek64" /usr/include and it showed this file */
#include <stdlib.h>
#include <stdio.h>
#include <string.h>
#include <limits.h>
...
#  else
#    define FILE_SEEK lseek /* originally this was FILE_SEEK_not_defined, I forced defined it as lseek */
#  endif
